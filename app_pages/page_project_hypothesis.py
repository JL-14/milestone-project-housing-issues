...
def page_project_hypothesis_body():
    ...
    Based on information from the credit checking agency Experian, the five factors that most affect a home’s value
    ...
    **Validation: True**. Based on the machine learning model developed to answer the first two hypotheses, a tool has
    been produced which will provide an estimated house price for any house based on its key characteristics. 
    """
    )
